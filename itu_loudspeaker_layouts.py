...
_m_az = (0, +22.5, -22.5, +30, -30, +45, -45, +60, -60, +90, -90, +110, -110, +135, -135, +180)
_m_el = 0
# there are two additional "M" speakers at the left and right edge of the display
...
def itu_all(r=1):
    ...
    a = lsl.append_layouts(m, u, name="ITU-All", 
                           description="All speakers in ITU docs")
