...
impmemetnation of the Ambisonic Decoder Toolbox (ADT). It is a work
...
Hence, a collection of M 3-D coordinates is written as an [3 x M]
...
In MATLAB, there are no 1-D arrays, so a column vector is a 3x1 atray and a
