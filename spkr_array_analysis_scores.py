...
def plot_tri(tri, name='foo', cmap_name='jet'):
    ...
    cvh_edges = np.concatenate([np.append(tri.points[f[face_indices]],
                                          face_end, axis=0)
...
skatz = np.array([
    [+9.93307380e-01, +0.00000000e+00, +1.15500858e-01],
...
envelop = np.array([
    [+9.24663218e-01, +3.80785941e-01, +0.00000000e+00],
    [+9.24663218e-01, -3.80785941e-01, +0.00000000e+00],
    [+4.67329915e-01, +8.84083000e-01, +0.00000000e+00],
    [+4.67329915e-01, -8.84083000e-01, +0.00000000e+00],
    [-4.67329915e-01, +8.84083000e-01, +0.00000000e+00],
    [-4.67329915e-01, -8.84083000e-01, +0.00000000e+00],
    [-9.24663218e-01, +3.80785941e-01, +0.00000000e+00],
